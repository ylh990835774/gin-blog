...
// @Param state query int false "State" Enums(1, 0)
// @Param created_by query false true "CreatedBy"
// @Success 200 {object} models.Article[]
...
// @Param state query int true "State" Enums(1, 0)
...
func EditArticle(c *gin.Context) {
	...
	valid.MaxSize(modifiedBy, 100, "modified_by").Message("修改为人最长为100字符")
